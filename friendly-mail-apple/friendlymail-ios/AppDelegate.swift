...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    static var backgroundAppRefreshTaskSchedulerIdentifier = "com.deovolentellc.friendlymail-ios.backgroundAppRefreshIdentifier"

    lazy public var logger: friendlymail_core.Logger = {
        return AppleLogger()
    }()
