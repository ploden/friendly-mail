...
public class AddFollowersSucceededCommandResult: CommandResult {
    ...
    public required init(createCommandMessageID: MessageID, commandType: CommandType, command: Command, user: EmailAddress, message: String, exitCode: CommandExitCode, follows: [UserFollow]) {
